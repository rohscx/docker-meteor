...
class ApicDevices extends Component {
  ...
  showCommandButton() {
    return (
      ...
      <SplitButton bsSize="xsmall" title="showCommandButton" id="split-button-dropdown" onClick={()=>{Meteor.call('apicShowCommands', function(error, result){ if (error){console.log(error)}})}}>
