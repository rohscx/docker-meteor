        ...
        const commandRunnerCheck = (cmdRunner) =>{
          ...
          const stringReplace = (string) => {
            const textColor = (textString)=>{
              switch (textString) {
                case "Active":
                return "<mark style=background-color:blue>"+textString+"</mark>"
                break;
                case "Standby":
                return "<mark style=background-color:red>"+textString+"</mark>"
                break;
                default:
                return textString;
              }
            ...
            const strReplace3 = strReplace2.replace(/Active|Standby/gi,(x)=>{return textColor(x)});
            return strReplace3;
          }
          if (cmdRunner) {
