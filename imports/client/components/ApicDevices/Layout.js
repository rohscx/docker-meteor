        ...
        return (
          <div key={data["_id"]} style= {divStyles}>
            <Row className="show-grid" style={rowStylesMain}>
              <Col xs={8} sm={6} md={4} lg={2}>{data.siteData.dataObj.hostname}</Col>
            ...
            <Row className="show-grid">
              ...
              <Col xs={6} sm={6} md={4} lg={3}>Up Time: {data.siteData.dataObj.upTime}</Col>
              <Col xs={6} sm={6} md={2} lg={1}>Int#: {data.siteData.dataObj.interfaceCount}</Col>
