        ...
        return (
          <div key={data["_id"]} style= {divStyles}>
            <Row className="show-grid" style={rowStylesMain}>
              <Col xs={8} sm={6} md={6} lg={6}>{data.siteData.dataObj.hostname}</Col>
              <Col xs={6} sm={6} md={3} lg={6}>{data.siteData.dataObj.role}</Col>
              <Col xs={6} sm={6} md={3} lg={6}>Updated @ UTC {data.siteData.dataObj.lastUpdated}</Col>
            </Row>
            <Row className="show-grid">
              <Col xs={5} sm={6} md={2} lg={6}><a href={sshLinkGen(mgmtIpAddress)}>{mgmtIpAddress}</a></Col>
              <Col xs={6} sm={6} md={2} lg={6}>  {reachCheck(status)}  </Col>
              <Col xs={6} sm={6} md={3} lg={6}>Ver: {data.siteData.dataObj.softwareVersion}</Col>
