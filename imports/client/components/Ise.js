    ...
    return (
      <div style={divStyles}>
        <Form horizontal>
          ...
          <FormGroup>
            {this.props.util.macValidation.btnStyle ? <Col smOffset={2} sm={10}><Button type="button" bsStyle="success">Submit</Button></Col> : <Col smOffset={2} sm={10}><Button  type="submit" disabled> <b> . . . </b></Button></Col>}
          </FormGroup>
        </Form>
