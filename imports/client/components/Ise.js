    ...
    return (
      <div style={divStyles}>
        <Form horizontal>
          ...
          <FormGroup>
            {this.props.util.macValidation.btnStyle ? <Col smOffset={2} sm={10}><Button type="submit">Submit</Button></Col> : <Col smOffset={2} sm={10}><Button  type="submit" disabled>...</Button></Col>}
          </FormGroup>
        </Form>
